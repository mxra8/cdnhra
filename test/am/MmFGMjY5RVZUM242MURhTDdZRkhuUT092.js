...
MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.gpt = {
    define: function() {
        var content = ['window.googletag = window.googletag || {};', 'googletag.cmd = googletag.cmd || [];', 'googletag.cmd.push(function() {', 'googletag.defineSlot("/21798689226/HRA_Article_MR", [300, 250], "div-gpt-ad-1558391321463-0").addService(googletag.pubads());', 'googletag.pubads().enableSingleRequest();', 'googletag.enableServices();', '});'];
