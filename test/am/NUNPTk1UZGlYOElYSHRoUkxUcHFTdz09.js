...
NUNPTk1UZGlYOElYSHRoUkxUcHFTdz09336x280.gpt = {
    define: function() {
        var content = ['window.googletag = window.googletag || {};', 'googletag.cmd = googletag.cmd || [];', 'googletag.cmd.push(function() {', 'googletag.defineSlot("/21798689226/HRA_Article_LR", [336, 280], "div-gpt-ad-1558388607247-0").addService(googletag.pubads());', 'googletag.pubads().disableInitialLoad();', 'googletag.pubads().enableSingleRequest();', 'googletag.enableServices();', '});'];
