...
var MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250 = MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250 || {};
MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.script = function(url) {
...
MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.reset = function() {
    MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.gpt = {};
};
MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.gpt = {
    define: function() {
        var content = ['window.googletag = window.googletag || {};', 'googletag.cmd = googletag.cmd || [];', 'googletag.cmd.push(function() {', 'googletag.defineSlot("/21798689226/HRA_Article_MR", [300, 250], "div-gpt-ad-1558391321463-0").addService(googletag.pubads());', 'googletag.pubads().disableInitialLoad();', 'googletag.pubads().enableSingleRequest();', 'googletag.enableServices();', '});'];
    ...
    display: function() {
        var content = ['googletag.cmd.push(function() {', 'googletag.display("div-gpt-ad-1558391321463-0")', '});'];
        var divP = document.createElement('div');
        divP.id = 'HRA_Article_MR';
        divP.style.width = '300px';
        divP.style.height = '250px';
        ...
        var s = MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.gpt.num();
        s = (s) ? 'blanco' : 'negro';
        ...
        div.id = 'div-gpt-ad-1558391321463-0';
    ...
    tag: function() {
        ...
        MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.script(url);
    },
    num: function() {
    ...
    aws: function() {
        ...
        apstag.fetchBids({
            slots: [{
                slotID: 'div-gpt-ad-1558391321463-0',
                slotName: '/21798689226/HRA_Article_MR',
                sizes: [
                    [300, 250]
                ]
            }],
    ...
    aws2: function() {
        var content = ["!function(a9,a,p,s,t,A,g){if(a[a9])return;function q(c,r){a[a9]._Q.push([c,r])}a[a9]={init:function(){q('i',arguments)},fetchBids:function(){q('f',arguments)},setDisplayBids:function(){},targetingKeys:function(){return[]},_Q:[]};A=p.createElement(s);A.async=!0;A.src=t;g=p.getElementsByTagName(s)[0];g.parentNode.insertBefore(A,g)}('apstag',window,document,'script','https://c.amazon-adsystem.com/aax2/apstag.js');", "apstag.init({", "pubID: 'e1506285-098d-4eac-8a37-858283a112f8', ", "adServer: 'googletag'", "});", "apstag.fetchBids({", "slots: [{", "slotID: 'div-gpt-ad-1558391321463-0',", "slotName: '/21798689226/HRA_Article_MR',", "sizes: [[300, 250]]", "}],", "timeout: 2e3", "}, function(bids) {", "googletag.cmd.push(function(){", "apstag.setDisplayBids();", "googletag.pubads().refresh();", "});", "});"];
        var script = document.createElement('script');
        script.type = 'text/javascript';
        script.text = content.join(' ');
        return script;
...
try {
    ...
    MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250HRA_Article_MR.appendChild(MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.gpt.define());
    MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250HRA_Article_MR.appendChild(MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.gpt.matomo());
    MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250HRA_Article_MR.appendChild(MmFGMjY5RVZUM242MURhTDdZRkhuUT09300x250.gpt.display());
} catch (e) {
    console.log(e);
};
